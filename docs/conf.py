...
"""
openedx-filters-samples documentation build configuration file.
...
project = 'openedx-filters-samples'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Open edX Filters Samples'
...
#
# html_title = 'openedx-filters-samples v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_filters_samples'),
                os.path.join(root_path, 'openedx_filters_samples/migrations')])
