#!/usr/bin/env python
"""
Package metadata for openedx_filters_samples.
"""
import os
import re
import sys
...
VERSION = get_version("openedx_filters_samples", "__init__.py")
...
setup(
    ...
    url="https://github.com/edx/openedx-filters-samples",
    packages=[
        "openedx_filters_samples",
    ],
